...
import 'package:albumapp/app/pages/auth/login/presenter/login_presenter.dart';
import 'package:albumapp/app/pages/auth/login/view/login_view_impl.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';
import 'package:validatorless/validatorless.dart';

class LoginPage extends StatefulWidget {
  final LoginPresenter prresenter;
  const LoginPage({super.key, required this.prresenter});
                ...
                delegate: SliverChildListDelegate.fixed([
                  ...
                  TextFormField(
                    ...
                    validator: Validatorless.multiple([
                      Validatorless.required("Obrigatório"),
                      Validatorless.min(
                          6, 'A senha deve conter 6 caracteres no minimo'),
                    ]),
                    decoration: const InputDecoration(
                      floatingLabelBehavior: FloatingLabelBehavior.never,
                      label: Text('Senha'),
                  ...
                  Button(
                    ...
                    onPressed: () {
                      ...
                      if (valid) {
                        showLoader();
                        widget.prresenter.login(emailEC.text, passwordEC.text);
                      }
                    },
