...
import 'package:albumapp/app/pages/auth/login/presenter/login_presenter_impl.dart';
import 'package:albumapp/app/services/login/login_service.dart';
import 'package:albumapp/app/services/login/login_service_impl.dart';
...
class LoginRoute extends FlutterGetItPageRoute {
  ...
  @override
  WidgetBuilder get page => (context) => LoginPage(prresenter: context.get());
}
